...
/**
 * JobeetJobs form base class.
 *
 * @method JobeetJobs getObject() Returns the current form's model object
 *
 * @package    jobeet
 * @subpackage form
 ...
 */
abstract class BaseJobeetJobsForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->validatorSchema->setPostValidator(
      new sfValidatorDoctrineUnique(array('model' => 'JobeetJobs', 'column' => array('token')))
    );

    $this->widgetSchema->setNameFormat('jobeet_jobs[%s]');
