...
/**
 * JobeetJobs filter form base class.
 *
 * @package    jobeet
 * @subpackage filter
 ...
 */
abstract class BaseJobeetJobsFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('jobeet_jobs_filters[%s]');
