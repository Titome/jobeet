  ...
  <body>
      <div id="container">
                  ...
                  <div id="sub_header">
                      ...
                      <div class="search">
                          ...
                          <form action="<?php echo url_for('job_search') ?>" method="get">
                              ...
                              <img id="loader" src="/jobeet/web/legacy/images/loader.gif"
          ...
          <div id="footer">
            <div class="content">
                <span class="symfony">
                    <img src="/web/legacy/images/jobeet-mini.png" /> powered by
                    <a href="/">
                        <img src="/web/legacy/images/symfony.gif" alt="symfony framework" />
                    </a>
                </span>
                <ul>
